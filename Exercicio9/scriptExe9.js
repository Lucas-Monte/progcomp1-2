...
alert(`A quantidade de pessoas com mais de 90kg e menores que 1,50m é igual a ${pesoSup90AltInf150}`)
if(Mais190 == 0){
    alert(`A porcentagem de pessoas entre 10 e 30 anos entre as pessoas com mais de 1,90m é incalculavel`)
}
else{
    alert(`A porcentagem de pessoas entre 10 e 30 anos entre as pessoas com mais de 1,90m é igual a ${(entre10E30*100)/Mais190}`)
}
