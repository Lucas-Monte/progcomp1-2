...
for (let i = 0; i < 6; i++) {
    let funcionario = {
        ...
        tempoServico: Number(prompt(`Informe o tempo de Serviço do ${i+1}° funcionario:`))
    };
...
for (let i = 0; i < funcionarios.length; i++) {
    if(funcionarios[i].salario > 5000 && funcionarios[i].tempoServico > 5) {
        console.log(`${funcionarios[i].nome} recebe mais de R$ 5000,00 e tem mais de 5 anos na empresa`)
    }
...
console.log(`Quem tem o maior salário é o ${maior.nome}, recebendo R$ ${maior.salario}`)
