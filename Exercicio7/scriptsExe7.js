...
if(pessoasEntre10E20Anos == 0){
    ...
    alert(`A média das alturas da pessoas entre 10 e 20 anos é igual a ${alturaEntre10E20Anos/pessoasEntre10E20Anos}`)
}
alert(`A porcentagem das pessoas com menos de 40 kg é ${(inferior40*100)/5}%`)